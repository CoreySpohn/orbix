...
def loglike_rv_marginalized(
    ...
    marginalization of zero-points γ_j collapses to O(N) segment sums. This
...
def loglike_astrom(ra_pred, dec_pred, data):
    ...
    Args:
        ...
        data: An :class:`~orbix.fitting.data.AstromData` instance.
...
def loglike_null(alpha_pred, dMag_pred, data):
    ...
    Args:
        ...
        data: A :class:`~orbix.fitting.data.NullData` instance.
    ...
    exp_arg = jnp.clip(-0.4 * (dMag_pred - dMag0_limit), a_max=200.0)
...
def loglike_imaging(alpha_pred, dMag_pred, data):
    ...
    Args:
        ...
        data: An :class:`~orbix.fitting.data.ImagingData` instance.
