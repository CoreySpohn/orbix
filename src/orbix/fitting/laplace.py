...
from orbix.fitting.data import (
    MAX_ASTROM,
    MAX_IMG,
    MAX_RV,
    AstromData,
...
def map_laplace_fit(
    ...
    *,
    ...
    Args:
        ...
        rv_data: An :class:`~orbix.fitting.data.RVData`, or ``None``.
        astrom_data: An :class:`~orbix.fitting.data.AstromData`, or ``None``.
        null_data: A :class:`~orbix.fitting.data.NullData`, or ``None``.
        imaging_data: An :class:`~orbix.fitting.data.ImagingData`, or ``None``.
    ...
    z_map, trajectory = optimize_map_static(
...
def map_laplace_mixture_fit(
    ...
    *,
    ...
    if init_list is None:
        ...
        if use_top_k_init:
            # CIRCULAR IMPORT: orbix.fitting.init → orbix.fitting.laplace
