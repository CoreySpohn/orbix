...
the pure-JAX likelihoods from :mod:`orbix.fitting.likelihoods`.
...
from orbix.fitting.priors import period_to_sma, sample_ecc_prior
...
def build_model(
    *,
    ...
    def model(Ms, dist_pc, rv_data, astrom_data, null_data, imaging_data):
        # CIRCULAR IMPORT: orbix.fitting.forward → orbix.fitting.numpyro_model
        from orbix.fitting.forward import (
            predict_astrometry,
            predict_photometry,
            predict_rv,
        )
        ...
        with numpyro.plate("planets", n_planets):
            ...
            # Eccentricity + ω via selected prior
        ...
        if n_planets == 1:
            ...
            # CIRCULAR IMPORT: orbix.fitting.forward → orbix.fitting.numpyro_model
            from orbix.fitting.forward import predict_astrometry as _pa
            from orbix.fitting.forward import predict_rv as _prv
