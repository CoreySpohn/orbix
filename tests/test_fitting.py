"""Tests for orbix.fitting module."""
...
from orbix.fitting.data import AstromData, NullData, RVData
...
class TestDiffSolveTrig:
    ...
    def test_grad_circular_orbit(self):
        """At e=0: E=M, so ∂(sinE)/∂M = cosM and ∂(cosE)/∂M = -sinM."""
...
class TestPredictPhotometry:
    ...
    def test_output_shape(self, eccentric_orbit):
        ...
        # Lambda = Ag * Rp² ≈ 0.3 * (1 Rearth)² in AU²
...
class TestLoglikeRV:
    ...
    def test_offset_invariance(self):
        ...
        This is the key property of the γ marginalization: the zero-point
...
class TestLoglikeAstrom:
    ...
    def test_uncorrelated_reduces_to_chi2(self):
        """With ρ=0, should reduce to independent Gaussian in RA and DEC."""
        data = AstromData(
            times=jnp.array([0.0]),
            ra=jnp.array([1.0]),
            dec=jnp.array([2.0]),
        ...
        # Manual χ²: ((1-1.1)/0.5)² + ((2-2.1)/0.5)² = 0.04 + 0.04 = 0.08
...
class TestPriors:
    ...
    def test_disk_transform_output_range(self):
        ...
        from orbix.fitting.priors import eccentricity_disk_transform
    ...
    def test_disk_transform_sigma_scaling(self):
        ...
        # σ=0.3 draws should put most mass below 0.5
        xy_03 = xy * 0.3
        ...
        # σ=0.049 draws should put nearly all mass below 0.2
        xy_005 = xy * 0.049
...
class TestThieleInnes:
    ...
    def _consistent_orbit():
        ...
        e = 0.3
        w = jnp.pi / 4  # ω = 45°
        # a from Kepler III: a = (μ * (T/2π)²)^(1/3)
        mu = G * Ms
    ...
    def test_recovers_sma_circular(self, circular_orbit):
        ...
        from orbix.fitting.thiele_innes import thiele_innes_fit
    ...
    def test_recovers_elements_eccentric(self):
        ...
        # cos_i recovery (up to sign — i vs π-i ambiguity)
        assert jnp.allclose(
    ...
    def test_chi2_near_n_dof(self):
        """With correct params, χ² ≈ N_datapoints - 4 (4 fitted params)."""
        from orbix.fitting.thiele_innes import thiele_innes_fit
        ...
        n_dof = 2 * n_pts - 4
        # χ² should be within a few sigma of n_dof
    ...
    def test_grid_search_finds_correct_period(self):
        ...
        from orbix.fitting.thiele_innes import thiele_innes_grid_search
...
class TestInit:
    ...
    def test_ti_to_init_keys(self):
        ...
        from orbix.fitting.init import ti_to_init
        from orbix.fitting.thiele_innes import thiele_innes_fit
    ...
    def test_find_init_top_k_returns_k_dicts(self):
        ...
        from orbix.fitting.init import find_init_top_k
